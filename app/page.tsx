        ...
        <div className="relative z-10 px-4 md:px-6 lg:px-8 max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            <div className="lg:col-span-3">
              ...
              <div className="mb-6">
                <TypingAnimation phrases={["Founder", "Product Manager", "Developer", "Designer", "Student Leader"]} />
              </div>
              <p className="text-zinc-400 mb-8 max-w-xl">
                With a passion for product and problem-solving, I thrive on turning ambiguous ideas into shipped, metric-driven solutions that people actually use.
              </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            <p className="text-lg text-zinc-300 leading-relaxed">
              Hi! I'm Ysobella Torio, a Computer Science graduate from 
              <span className="text-cyan-400"> De La Salle University, Manila</span>, majoring in Software Technology. 
              My passion lies at the intersection of product, technology, and impact.
            </p>
            <p className="text-lg text-zinc-300 leading-relaxed">
              Most recently, I was a 
              <span className="text-purple-400"> Product Manager at Moongig</span>, a healthcare staffing marketplace, 
              where I owned the end-to-end product roadmap, scaling the platform from 6,000 to 24,000 healthcare professionals and 
              leading a cross-functional team of ~10 through the full product development lifecycle, from PRDs to release.
            </p>
            <p className="text-lg text-zinc-300 leading-relaxed">
              Before that, I co-founded <span className="text-yellow-400"> BoxCrib</span>, a construction supply marketplace, 
              and <span className="text-yellow-400"> Dala</span>, an AI-powered mental health platform.        
            </p>
            {/* <p className="text-lg text-zinc-300 leading-relaxed">
            ...
            <p className="text-lg text-zinc-300 leading-relaxed">
              Whether through product management or founding my own ventures, 
              I love building solutions that are meaningful, technically sound, and human-centered.
            </p>
          </div>
        </div>
      </section>
